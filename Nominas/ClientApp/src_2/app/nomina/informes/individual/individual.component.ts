    ...
    this.personaService.Buscar(this.buscar).subscribe(result => {
      ...
      if (this.persona != null) {
        ...
        this.personaService.getGrupal().subscribe(result => {
          this.pagos = result;
          var valormes =0;
          if (this.persona.tipoContrato == "Aprendizaje") {
            valormes= 500;
          } else if (this.persona.tipoContrato == "ObraLabor") {
            valormes= 1000;
          } else if (this.persona.tipoContrato == "Ocasional") {
            valormes= 1500;
          } else if (this.persona.tipoContrato == "PrestacionServicios") {
            valormes= 2000;
          } else if (this.persona.tipoContrato == "Fijo") {
            valormes= 2500;
          } else if (this.persona.tipoContrato == "Indefinido") {
            valormes= 3000;
          }

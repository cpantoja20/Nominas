...
namespace Nominas
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<PagosContext>(p => p.UseSqlServer(connectionStrin));
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "Nominas API",
                    Description = "Nominas API - ASP.NET Core Web API",
                    TermsOfService = new Uri("https://cla.dotnetfoundation.org/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Nominas",
                        Email = string.Empty,
                        Url = new Uri("https://github.com/cpantoja20/Nominas"),
                    },
